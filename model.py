...
class primary_encoder_v2_no_pooler_for_con(nn.Module):
    ...
    def __init__(self,hidden_size,emotion_size,encoder_type="/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base"):
        super(primary_encoder_v2_no_pooler_for_con, self).__init__()
        

        if encoder_type == "/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base" or encoder_type=="bert-custom" or encoder_type=="HateBERT":
            options_name = "/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base"
...
class weighting_network(nn.Module):
    def __init__(self,hidden_size,emotion_size,encoder_type="/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base"):
        ...
        if encoder_type == "/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base":
            options_name = "/data2/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/phobert-base"
            self.encoder_supcon = BertModel.from_pretrained(options_name,num_labels=emotion_size,
            )
            self.encoder_supcon.encoder.config.gradient_checkpointing=False
